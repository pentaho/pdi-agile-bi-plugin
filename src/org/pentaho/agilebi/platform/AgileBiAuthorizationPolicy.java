 ...
 * with true.
 *
 * @see https://github.com/pentaho/pentaho-osgi-bundles/blob/7.0.0.0-R/pentaho-pdi-platform/src/main/java/org/pentaho/platform/pdi/AgileBiAuthorizationPolicy.java
 */
